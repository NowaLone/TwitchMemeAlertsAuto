...
| Возможность спалить последнего мемера                                                | ✅  | ❌  |
| Возможность отправить случайный мем                                                  | ✅  | ❌  |
| Возможность включить тихий режим                                                     | ✅  | ❌  |
| Возможность отправить мем через текст в награде                                      | ✅  | ❌  |
...
В меню "Файл" есть кнопки для включения автозапуска, награждения по нику твича

В меню "Награды" есть кнопки для создания Twitch наград позволяющей сообщить в чат кто отправил последний мем и отправки случайного мема

Награда о последем отправленом меме пишет в чат от вашего имени ник отправившего и название стикера. **ОСТОРОЖНО** название мемов могут содержать нецензурные слова, в программу встроен простой фильтр но это ничего не гарантирует и вы действуеете на свой страх и риск

Случайный мем выбирается из 200 топ стикеров со страницы вашего канала + 200 последних стикеров добавленых на memealerts (страница "Каталог" на сайте). Мем отправляется от вашего имени

Награда через текст делает поиск мема по введёному в награду тексту и отправляет первый подходящий
