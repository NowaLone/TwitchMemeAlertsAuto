...
В меню "Файл" есть кнопки для включения автозапуска, награждения по нику твича и создание Twitch награды позволяющей сообщить в чат кто отправил последний мем
